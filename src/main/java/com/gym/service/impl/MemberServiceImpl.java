...
public class MemberServiceImpl implements MemberService {
    ...
    @Override
    public Member selectByPhone(String memberPhone) {
    ...
    public List<Member> selectByRegex(String field, String value, String operator, Integer numValue, String likePattern) {
        if (operator == null && numValue == null && likePattern == null) {
            ...
            return memberMapper.selectByRegex(field, parsed.operator, parsed.numValue, parsed.likePattern, parsed.startDate, parsed.endDate);
        }
